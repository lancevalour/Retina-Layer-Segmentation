...
function [retinalLayers, params] = getRetinalLayers(img)
%%
%
...
% if isPlot,
    ...
    for k =7 :7
        ...
        if ~isempty(retinalLayers(layerToPlotInd).pathX)            
            ...
            plot(retinalLayers(layerToPlotInd).pathY,retinalLayers(layerToPlotInd).pathX-1,'-','color',colora,'linewidth',1);
